...
-- =========================================
-- TABELA CIDADES
-- 2 cidades por estado = 4 cidades
-- =========================================
...
INSERT INTO cidades (nome, quantidade_habitantes, id_estado) VALUES
('Blumenau', 361000, 1),
('Joinville', 616000, 1),
('Curitiba', 1773000, 2),
('Londrina', 575000, 2);
...
-- =========================================
-- TABELA BAIRROS
-- 2 bairros por cidade = 8 bairros
-- =========================================
...
-- =========================================
-- TABELA ENDEREÇOS
-- 1 endereço por bairro = 8 endereços
-- =========================================
...
(cep, logradouro, numero, complemento, id_bairro)
VALUES
('89010-000', 'Rua XV de Novembro', '100', NULL, 1),
('89036-000', 'Rua João Pessoa', '250', 'Casa', 2),

('89201-000', 'Rua do Príncipe', '300', NULL, 3),
('89204-000', 'Rua Blumenau', '450', 'Apartamento 202', 4),

('80010-000', 'Rua Marechal Deodoro', '500', NULL, 5),
('80420-090', 'Avenida do Batel', '700', 'Sala 10', 6),

('86010-000', 'Avenida Paraná', '800', NULL, 7),
('86050-000', 'Rua João Huss', '900', 'Apartamento 305', 8);
